...
public class AbilitiesMenu extends Gui {
    ...
    public AbilitiesMenu(Player player) {
        ...
        addButton(14, new AbilityButton(AbilityTypes.FRIENDLY_MOBS, Material.ZOMBIE_SPAWN_EGG, List.of("Become frenemies with &#FFD392Zombies&#A7A4A0, &#FFD392Skeletons&#A7A4A0", "and &#FFD392Spiders&#A7A4A0, they will &#FFD392no longer", "&#FFD392attack you &#A7A4A0unless provoked")));
